...
$LANG["fr"] = [
	"account" => "Account_trToFr",
	"admin" => "Administration_trToFr",
    "article" => "Article_trToFr",
    "category" => "Categorie",
    "manufacturer" => "Manufacturer_trToFr",
    "login" => "Login_trToFr",
    "logout" => "Logout_trToFr",
    "search" => "Rechérche",
    "home" => "Home_trToFr",
	...
	"basket" => "Basket_trToFr",
	"noArticlesCart" => "No article in your cart_trToFr",
